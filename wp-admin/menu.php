...
$menu[5] = array( __(is_super_admin() ? 'Posts' : 'Advertisements'), 'edit_posts', 'edit.php', '', 'open-if-no-js menu-top menu-icon-post', 'menu-posts', 'none' );
	$submenu['edit.php'][5]  = array( __(is_super_admin() ? 'All Posts' : 'All Ads'), 'edit_posts', 'edit.php' );
